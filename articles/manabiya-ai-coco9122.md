...
テクノロジーの進化による授業のデジタル化が急務だ。しかし、実際の教育現場では、IT化が、促進されておら図、現行方式から変化を嫌う教師が多数存在する。
...
**プロジェクト詳細・リポジトリ**:  
https://github.com/teamshackathon/ai_agent_frontend
https://github.com/teamshackathon/ai_agent_websocket
